...
namespace DarkTreeFPS
{
    ...
    public class Weapon : MonoBehaviour
    {
        ...
        private GameObject[] decals; // warning CS0649: Field 'Weapon.decals' is never assigned to, and will always have its default value null
        ...
        private void Start()
        {
            ...
            reticle = FindFirstObjectByType<ReticleAnimation>().gameObject;

            UIScopeGameobject = weaponManager.scopeUI;

            coverList = FindFirstObjectByType<CoverList>();
            ...
            hitFXManager = FindFirstObjectByType<HitFXManager>();
            ...
            inventory = FindFirstObjectByType<DTInventory.DTInventory>();
