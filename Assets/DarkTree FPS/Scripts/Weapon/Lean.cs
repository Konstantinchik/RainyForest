...
namespace DarkTreeFPS
{
    ...
    public class Lean : MonoBehaviour
    {
        ...
        private float leanCurrentPosition; // warning CS0169: The field 'Lean.leanCurrentPosition' is never used

        Quaternion leanRotation;    // Lean.cs(24,20): warning CS0169: The field 'Lean.leanRotation' is never used
